...
final class PartnerRemovedSerializer implements MessengerSerializer
{
    ...
    {
        try {
            $event = $this->serializer->deserialize($encodedEnvelope['body'], PartnerRemovedMessage::class, 'json');
        } catch (\Exception $e) {
